(() => {
  ...
  function getPaceRange(ltpSec, zoneIdx, isTrail) {
    ...
    const trailFactor = isTrail ? 1.18 : 1;
    return {
  ...
  function DayCard({ dayName, dayDate, dayData, lthr, ltpSec, isTrail, completed, onToggleComplete, isToday, logData, onSaveLog, onDeleteLog }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: {
      ...
      borderRadius: "var(--border-radius-md)",
      fontWeight: 500
    } }, "vandaag")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "15px", fontWeight: 500, marginBottom: "4px" } }, dayData.type), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "13px", color: "var(--color-text-secondary)", marginBottom: "6px" } }, dayData.description, dayData.distance > 0 && /* @__PURE__ */ React.createElement("span", { style: { marginLeft: "8px", color: "var(--color-text-tertiary)" } }, "\xB7 ", dayData.distance, " km \xB7 ~", dayData.duration, " min")), !isRestDay && dayData.zone !== null && /* @__PURE__ */ React.createElement(ZoneTag, { lthr, ltpSec, isTrail, zoneIdx: dayData.zone })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "6px", flexShrink: 0 } }, !isRestDay && /* @__PURE__ */ React.createElement(
      "button",
      {
  ...
  function App() {
    ...
    }, [distance, raceDate, lthr, ltpStr, completed, logs, activeWeek, loaded]);
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { padding: "1rem 0", fontFamily: "var(--font-sans)" } }, /* @__PURE__ */ React.createElement("h2", { className: "sr-only" }, "Trainingsplanner voor hardlopen op basis van wedstrijddatum en lactaatdrempel"), /* @__PURE__ */ React.createElement("div", { style: {
      ...
      "input",
      {
        type: "number",
        value: lthr,
        onChange: (e) => setLthr(Math.max(120, Math.min(220, +e.target.value || 170))),
        min: 120,
        max: 220,
        style: { width: "100%" }
      }
